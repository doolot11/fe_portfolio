        ...
        <div className='cardRotate  my-[30px]'>
            <div className='bg-gradient-to-r p-[1px] from-[#B30A94] to-[#492BFF] rounded-xl '>
                <div className='bg-black p-[10px] rounded-xl relative'>
                    ...
                    <p className='text-center text-wrap max-w-[400px] my-[20px] text-[#fff]'>{data.title} <a className='underline text-[#492BFF]' href={data.url}>{data.urlTitle}</a> </p>
                    <button className='border border-[#492BFF] py-[8px] px-[30px] rounded-full bg-[#492BFF] 
               bottom-[-20px] absolute left-1/2 transform -translate-x-1/2  transition-all duration-300 hover:scale-105 hover:bg-[#492BFF] text-white'>VIEW DETAIL</button>
